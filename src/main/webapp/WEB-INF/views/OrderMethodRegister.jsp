			...
			<div class="card-body">
				<form:form action="register" method="post"
					...
					<div class="form-group">
						<label for="orderMode" class="control-label col-sm-2">Order
							Mode</label><br>
						<form:radiobuttons path="orderMode" items="${orderMode}"
							cssClass="radio offset-sm-1" />
						<form:errors path="orderMode" items="${orderMode}"
							cssClass="text-danger" />
					</div>

					<div class="form-group">
						<label for="orderCode" class="control-label col-sm-4">Order
							Code</label>
					...
					<div class="form-group">
						<label for="orderMethd" class="control-label col-sm-4">Order
							Method</label>
					...
					<div class="form-group">
						<label for="orderAccept" class="control-label col-sm-2">Order
							Accept</label><br>
						<form:checkboxes path="orderAccept" items="${orderAccept}"
							cssClass="checkbox offset-sm-1" /><br/>
