...
public class UomRestController {
	...
	public ResponseEntity<Object> getAll() {
		...
		List<Uom> uomLst = service.getAll();
		if (uomLst == null || uomLst.size() == 0) {
			response = "No Uom Records Exist.";
		} else {
			response = uomLst;
		}
		return ResponseEntity.ok(response);
		// return new ResponseEntity(uomLst,HttpStatus.OK);
	}// method
	...
	public ResponseEntity<Object> getByUomId(@PathVariable Long uomId) {
